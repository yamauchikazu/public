...
---------------------------------------
<b>Note: The WindowsUpdateProvider module is no longer included in Windows 10/Server ver 2004 (20H1) that clean insalled. If you upgrade from a previous version, the module may remain, but it will no longer work. (Updated 2020/05/15) -> Workaround: use windowsupdate.vbs or Windowsinteractiveupdate.vbs in https://github.com/yamauchikazu/public/</b>(Updated 2020/12/11)
